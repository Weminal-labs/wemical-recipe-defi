...
export const BookIcon = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M12 5.49001V20.49" stroke="#8D8B8C" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
      <path d="M7.75 8.49001H5.5" stroke="#8D8B8C" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
      <path d="M8.5 11.49H5.5" stroke="#8D8B8C" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
    </svg>
  );
};
