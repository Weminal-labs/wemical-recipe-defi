import CetusClmmSDK, { CoinProvider, PathProvider, Percentage, SdkOptions, adjustForSlippage, d } from '@cetusprotocol/cetus-sui-clmm-sdk'
...
export async function smartRouterSwap() {
    ...
    // TestnetSDK.Router.loadGraph(coins, paths)


    // // The first two addresses requiring coin types.
    // const byAmountIn = false
    // const amount = new BN('1000000000000')
    // const res = (await TestnetSDK.RouterV2.getBestRouter(SUI, USDC, 11111111000000, true, 0.5, '', undefined, true, false))
