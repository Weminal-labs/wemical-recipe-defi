...
import { createTxbStake, createTxbSwap, createTxbSwapOposite } from "./api/aftermath";
...
export default function index() {
  ...
  const handleSwapOposite = async () => {
    const txb = await createTxbSwapOposite(BigInt(1_000_000_000));
  ...
  return (
    <>
      ...
      <button type="button" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={handleSwapOposite}>Swap Oposite</button>
    </>
  );
}
